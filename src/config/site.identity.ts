export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'kumarparashar',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Kumarparashar',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'kumarparashar.in',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://kumarparashar.in',
